...
> Status: Milestones 0 and 1 are implemented: repository tooling, pure core contracts, and the
> credential document codec. OAuth, DSH integration, and the CLI are not implemented, so there is
> no usable plugin yet.
